...
#include "Engine/Structures/ColorText.hpp"
...
typedef ThreadSafeVector<ColoredText> ColorStrings;
...
public:
	...
	static	void		LoggerHookHandler( const LogMessage& msg, void* userData );
...
private:
			...
			float			m_fontToScreenRatio = 0.015f;
